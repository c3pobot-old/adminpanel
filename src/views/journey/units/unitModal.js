...
export default function EditModal ({open, setOpen, saveUnit, deleteUnit, unit, combatType}){
  ...
  return (
    <Modal open={open} onClose={handleClose} aria-labelledby="modal-modal-title" aria-describedby="modal-modal-description">
      ...
      <Table>
        <TableHead>
          <TableRow><TableCell colSpan="2"><Typography>{unit?.nameKey || 'Unit Defaults'}</Typography></TableCell></TableRow>
        </TableHead>
        <TableBody>
          <TableRow>
            <TableCell colSpan="2">
